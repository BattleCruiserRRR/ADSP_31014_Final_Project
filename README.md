...
GA : A → B (e.g., Van Gogh paintings → photographs)

GB : B → A (photographs → Van Gogh paintings)

DA, DB discriminate between real and generated images in each domain
...
<img width="976" height="506" alt="sample_picture" src="https://github.com/user-attachments/assets/b2a21d74-cd0f-4cdd-a34a-de853a12a8f5" />
